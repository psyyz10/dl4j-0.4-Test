...
//        Nd4j.getRandom().setSeed(seed);
    ...
    public void testMath() {
        ...
        testMatrixOperation(POW, matrixLargeLeft, matrixLargeRight, "4096 * 4096 matrix pow operation", 10);
        testMatrixOperation(POW, matrixMidLeft, matrixMidRight, "512 * 512 matrix pow operation", 30);
        testMatrixOperation(POW, matrixSmallLeft, matrixSmallRight, "32 * 32 matrix pow operation", 30);
        testMatrixOperation(LOG, matrixLargeLeft, matrixLargeRight, "4096 * 4096 matrix log operation", 10);
        testMatrixOperation(LOG, matrixMidLeft, matrixMidRight, "512 * 512 matrix log operation", 30);
        testMatrixOperation(LOG, matrixSmallLeft, matrixSmallRight, "32 * 32 matrix log operation", 30);
        testMatrixOperation(EXP, matrixLargeLeft, matrixLargeRight, "4096 * 4096 matrix exp operation", 10);
        testMatrixOperation(EXP, matrixMidLeft, matrixMidRight, "512 * 512 matrix exp operation", 30);
        testMatrixOperation(EXP, matrixSmallLeft, matrixSmallRight, "32 * 32 matrix exp operation", 30);
        testMatrixOperation(SQRT, matrixLargeLeft, matrixLargeRight, "4096 * 4096 matrix sqrt operation", 10);
        testMatrixOperation(SQRT, matrixMidLeft, matrixMidRight, "512 * 512 matrix sqrt operation", 30);
        testMatrixOperation(SQRT, matrixSmallLeft, matrixSmallRight, "32 * 32 matrix sqrt operation", 30);
